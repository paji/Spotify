...
def generate_rss(mp3_files):
    ...
    if existing_tree:
        ...
        ET.SubElement(channel, '{http://www.itunes.com/dtds/podcast-1.0.dtd}explicit').text = PODCAST_EXPLICIT
        ...
        ET.SubElement(owner, '{http://www.itunes.com/dtds/podcast-1.0.dtd}name').text = PODCAST_OWNER_NAME
        ET.SubElement(owner, '{http://www.itunes.com/dtds/podcast-1.0.dtd}email').text = PODCAST_OWNER_EMAIL
    ...
    for mp3 in mp3_files:
        ...
        # iTunes固有のタグ - 完全なURI形式を使用
        ET.SubElement(item, '{http://www.itunes.com/dtds/podcast-1.0.dtd}duration').text = mp3['duration']
        ET.SubElement(item, '{http://www.itunes.com/dtds/podcast-1.0.dtd}author').text = PODCAST_AUTHOR
        ET.SubElement(item, '{http://www.itunes.com/dtds/podcast-1.0.dtd}summary').text = mp3['description']
